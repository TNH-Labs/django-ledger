    ...
    class Meta:
        ...
        widgets = {
            'po_title': TextInput(attrs={
                'class': DJANGO_LEDGER_FORM_INPUT_CLASSES + ' is-large','placeholder': 'What this PO is about...'}),
            'po_status': Select(attrs={'class': DJANGO_LEDGER_FORM_INPUT_CLASSES}),
            'po_amount': TextInput(attrs={ 'class': DJANGO_LEDGER_FORM_INPUT_CLASSES + ' is-large'}),
            'po_amount_received': TextInput(attrs={ 'class': DJANGO_LEDGER_FORM_INPUT_CLASSES + ' is-large'}),
            # 'date_draft': DateInput(attrs={ 'class': DJANGO_LEDGER_FORM_INPUT_CLASSES}),
            # 'date_in_review': DateInput(attrs={ 'class': DJANGO_LEDGER_FORM_INPUT_CLASSES}),
            'markdown_notes': Textarea(attrs={'class': DJANGO_LEDGER_FORM_INPUT_CLASSES + ' is-large'}),
        }
        labels = {
